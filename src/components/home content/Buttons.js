    ...
    <section>
      <article className="flex flex-col gap-[4rem]">
        <button className="three-borders purple">
          <span className="flex items-center border-[1px] border-[#FF76E1]">
            <Image
        ...
        <button className="three-borders yellow">
          <span className="flex items-center border-[1px] border-[#FFF176]">
            <Image
        ...
        <button className="three-borders blue">
          <span className="flex items-center border-[1px] border-[#76F7FF]">
            <Image
        ...
        <button className="three-borders purple">
          <span className="flex items-center border-[1px] border-[#b202d1]">
            <Image
